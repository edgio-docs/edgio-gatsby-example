...
const showcases = [
  `Layer0's Compatbility with Gatsby`,
    ...
    <div className="flex min-h-[calc(100vh-56px)] flex-col items-center px-5 md:px-0">
      <div className="mt-10 flex w-full max-w-2xl flex-col p-2.5">
        ...
        <div className="mt-5 flex flex-row items-center space-x-3 text-lg text-[#FFFFFF90]">
          ...
          <a target="_blank" className="border-b border-[#FFFFFF75] text-sm md:text-lg" href="https://github.com/layer0-docs/layer0-gatsby-example">
            layer0-docs/layer0-gatsby-example
          </a>
        </div>
